...
<head>
  ...
  <!-- Bootstrap CSS + JS bundle (quan trọng cho dropdown) -->
  ...
  <style>
    ...
    #topbar {
      ...
      display: flex; align-items: center; transition: all 0.5s; color: #fff;
      background: rgba(0,0,0,0.4);
    }
    #topbar.topbar-scrolled { top: -40px; }

    #header {
      height: 90px; position: fixed; top: 40px; left: 0; right: 0; z-index: 997;
      background: rgba(0, 0, 0, 0.2); transition: all 0.5s;
    ...
    .navbar a {
      ...
      font-weight: 600; text-transform: uppercase; text-decoration: none; transition: 0.3s;
    }
    ...
    .auth-btn {
      ...
      padding: 8px 18px; border-radius: 50px; transition: 0.3s; text-decoration: none;
    }
    .login-btn { color: #fff; background: transparent; }
    .login-btn:hover { color: #cda45e; }
    .register-btn {
      color: #fff; border: 2px solid #cda45e; background: rgba(205, 164, 94, 0.1);
    }
    .register-btn:hover { background: #cda45e; color: #1a1814; }
    .book-a-table-btn {
    ...
    /* Dropdown tài khoản */
    .dropdown-menu-dark {
      background: #1a1814; border: 1px solid #cda45e; border-radius: 8px;
    }
    .dropdown-menu-dark .dropdown-item {
      color: #fff; transition: 0.2s;
    }
    .dropdown-menu-dark .dropdown-item:hover {
      background: rgba(205,164,94,0.15); color: #cda45e;
    }
...
<body>
          ...
          <?php if(isset($_SESSION['user_id'])): ?>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark shadow">
                ...
                <?php endif; ?>
                <li><a class="dropdown-item" href="profile.php"><i class="bi bi-person me-2" style="color: #cda45e;"></i>Thông tin cá nhân</a></li>
                <li><a class="dropdown-item" href="my_orders.php"><i class="bi bi-receipt me-2" style="color: #cda45e;"></i>Lịch sử đặt bàn</a></li>
                <li><hr class="dropdown-divider" style="border-color: rgba(205,164,94,0.3);"></li>
  ...
  <!-- Bootstrap JS (PHẢI CÓ để dropdown hoạt động) -->
