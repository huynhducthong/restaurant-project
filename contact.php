...
.contact-hero p { color: #eee; font-style: italic; }
...
.info-item:hover { border-color: #cda45e; }
.info-item i {
    font-size: 1.8rem;
    color: #cda45e;
    margin-right: 15px;
...
.info-item h5 { color: #cda45e; margin-bottom: 5px; }
                    ...
                    <div class="form-wrapper">
                        ...
                        <form action="contact.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="subject" class="form-control" placeholder="Tiêu đề lời nhắn" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nội dung</label>
                                <textarea name="message" rows="5" class="form-control" placeholder="Viết nội dung bạn muốn gửi..." required></textarea>
                            </div>
