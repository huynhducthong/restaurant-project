                                ...
                                <div class="tab-pane <?= $active_tab === 'general' ? 'show active' : '' ?> pt-2" id="general" role="tabpanel" aria-labelledby="general-tab" tabindex="0">
                                    ...
                                    <div class="mt-4 border-top pt-4">
                                        ...
                                        <div class="row">
                                            <?php 
                                            $banners = [
                                                'banner_about' => ['label' => 'Trang Về Chúng Tôi', 'default' => 'assets/img/about_bg_premium.jpg'],
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-sm border-0 bg-light mb-4">
                                        <div class="card-body">
                                            ...
                                            <form action="/admin/controllers/GalleryController.php?action=store" method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
