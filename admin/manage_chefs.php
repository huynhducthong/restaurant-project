...
if (isset($_POST['btn_save'])) {
    ...
    try {
        if ($chef_id) {
            ...
            $params = [':n'=>$name,':p'=>$position,':img'=>$image_name,':exp'=>$experience,
                       ':sp'=>$specialty,':desc'=>$description,':q'=>$quote,':fb'=>$facebook,
                       ':ig'=>$instagram,':em'=>$email,':ia'=>$is_active,':if2'=>$is_featured,
                       ':so'=>$sort_order,':id'=>$chef_id];
...
.badge-featured { background: #cda45e; color: #fff; }
.table th { background: #2c3e50; color: #ecf0f1; }
.section-card { background: #fff; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,.08); padding: 28px; }
.form-label { font-weight: 600; color: #2c3e50; }
.btn-gold { background: #cda45e; border-color: #cda45e; color: #fff; }
.btn-gold:hover { background: #b8903e; color: #fff; }
</style>
        ...
        <div class="col-xl-5 col-lg-5">
            <div class="section-card h-100">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Câu nói nổi bật -->
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-quote-left me-1 text-warning"></i>Câu nói nổi bật</label>
        ...
        <div class="col-xl-7 col-lg-7">
            <div class="section-card">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5 class="mb-0" style="color:#2c3e50; border-bottom:2px solid #cda45e; padding-bottom:10px; width:100%">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <?php if (!empty($chef['specialty'])): ?>
                                            <small class="text-muted"><?= htmlspecialchars($chef['specialty']) ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
            ...
            <!-- Hướng dẫn nhanh -->
            <div class="section-card mt-4" style="background: linear-gradient(135deg,#f8f9fa,#fff8ee); border-left: 4px solid #cda45e;">
