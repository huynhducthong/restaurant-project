                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <?php if ($chef['image']): ?>
                                        <img src="<?= BASE_URL ?>/public/assets/img/chefs/<?= htmlspecialchars($chef['image']) ?>" class="shadow-sm" style="width: 45px; height: 45px; object-fit: cover; border-radius: 10px;" alt="Avatar">
                                    <?php else: ?>
        ...
        images.forEach(img => {
            ...
            card.innerHTML = `
                <div class="position-relative w-100" style="height: 100px; overflow: hidden; border-radius: 4px;">
                    <img src="<?= BASE_URL ?>/public/assets/img/chefs/gallery/${img.image}" style="width: 100%; height: 100%; object-fit: cover;" alt="Gallery">
                </div>
        ...
        certs.forEach(cert => {
            ...
            card.innerHTML = `
                <div class="position-relative w-100 mb-2" style="height: 140px; overflow: hidden; border-radius: 4px; border: 1px solid #ddd; background: #fff;">
                    <img src="<?= BASE_URL ?>/public/assets/img/chefs/certificates/${cert.certificate_image}" style="width: 100%; height: 100%; object-fit: contain;" alt="Certificate">
                </div>
                <div class="w-100">
