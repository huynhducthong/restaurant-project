                                ...
                                <?php if (!empty($galleries)): ?>
                                    <?php foreach ($galleries as $gallery): ?>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="<?= BASE_URL ?>/admin/galleries.php?action=toggle&id=<?= $gallery['id'] ?>" class="btn btn-sm <?= $gallery['is_active'] ? 'btn-outline-warning' : 'btn-outline-success' ?>" title="<?= $gallery['is_active'] ? 'Ẩn ảnh này' : 'Bật ảnh này' ?>">
                                                    <i class="bi <?= $gallery['is_active'] ? 'bi-eye-slash' : 'bi-eye' ?>"></i>
                                                </a>
                                                <a href="<?= BASE_URL ?>/admin/galleries.php?action=delete&id=<?= $gallery['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa hình ảnh này không?');" title="Xóa">
