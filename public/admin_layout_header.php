    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <div class="menu-scroll">
            <ul class="menu-list">
                ...
                <?php if (checkMenuAccess($user_role, ['admin', 'manager', 'cashier', 'staff', 2, 'chef'])): ?>
                ...
                <li class="<?= $isServiceMenu ? 'active' : '' ?>">
                    ...
                    <ul class="collapse list-unstyled <?= $isServiceMenu ? 'show' : '' ?>" id="servicesSubmenu" style="background: rgba(0,0,0,0.03);">
                        ...
                        <li class="<?= isActive('manage_service_reviews.php') ?>">
                            <a href="<?= BASE_URL ?>/admin/manage_service_reviews.php" style="padding-left: 42px; font-size: 12.5px;">
                    ...
                    <ul class="collapse list-unstyled <?= $isChefMenu ? 'show' : '' ?>" id="chefSubmenu" style="background: rgba(0,0,0,0.03);">
                        ...
                        <li class="<?= isActive('manage_chef_reviews.php') ?>">
                            <a href="<?= BASE_URL ?>/admin/manage_chef_reviews.php" style="padding-left: 42px; font-size: 12.5px;">
                                <i class="fas fa-star" style="font-size: 12px; margin-right: 6px;"></i> Đánh giá Đầu bếp
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <header class="topbar">
            <div class="d-flex align-items-center gap-2">
                ...
                $page_titles = [
                    ...
                    'manage_service_reviews.php' => 'Quản Lý Đánh Giá Khách Hàng',
